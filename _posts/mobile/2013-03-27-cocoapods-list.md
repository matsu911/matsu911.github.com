...
category: Mobile
tags: [Mobile]
keywords: [iPhone,Cocoapods,podspec]
---
{% include JB/setup %}
...
## [A2DynamicDelegate](https://github.com/pandamonia/A2DynamicDelegate)
Blocks are to functions as A2DynamicDelegate is to delegates.
## [A2StoryboardSegueContext](https://github.com/pandamonia/A2StoryboardSegueContext/)
Supplement your segues' identifier strings with context objects.
## [A3GridTableView](https://github.com/allaboutapps/A3GridTableView)
...
## [AAImageUtils](https://github.com/ahmet/AAImageUtils)
Simple framework to let your application's launch image fade-out to its initial view.
## [AALaunchTransition](https://github.com/ahmet/AALaunchTransition)
Simple framework to let your application's launch image fade-out to its initial view.
...
## [adlibr](https://github.com/mocoplex/adlibr-SDK-ios/)
...
## [AdMobHelper](https://github.com/youknowone/AdMobHelper)
...
## [AdPostSDK](https://github.com/youknowone/AdPostSDK)
AdPost iOS SDK with Helper.
## [ADVProgressBar](https://github.com/appdesignvault)
Progress Bar Design with Percentage values.
## [AeroGear](https://github.com/aerogear/aerogear-ios)
Provides a lightweight set of utilities for communication, security, storage and more.
## [AeroGear-OTP](https://github.com/aerogear/aerogear-otp-ios)
Provides an Objective-C One Time Password API.
## [AFAmazonS3Client](https://github.com/AFNetworking/AFAmazonS3Client)
AFNetworking Client for the Amazon S3 API.
## [AFCache](https://github.com/artifacts/AFCache)
...
## [AFHTTPRequestOperationLogger-VolumeControl](https://github.com/OliverLetterer/AFHTTPRequestOperationLogger-VolumeControl)
...
## [AFXAuthClient](https://github.com/romaonthego/AFXAuthClient)
...
## [AKTabBarController](https://github.com/alikaragoz/AKTabBarController)
AKTabBarController is an adaptive and customizable tab bar for iOS.
## [ALActionBlocks](https://github.com/lavoy/ALActionBlocks)
ALActionBlocks Category on UIControl to allow use of blocks instead of selectors.
## [ALAssetsLibrary-CustomPhotoAlbum](https://github.com/Kjuly/ALAssetsLibrary-CustomPhotoAlbum)
...
## [AlgoliaSearchOffline-iOS-SDK](http://www.algolia.com)
...
## [AlgoliaSearchOffline-OSX-SDK](http://www.algolia.com)
Algolia Search Offline enables developers to quickly deliver Google-like instant search inside their apps, with features like type ahead search, typo-tolerance, instant visual feedback and geosearch.
## [AlphabetTable](https://github.com/idottv/AlphabetTable)
...
## [ALRadial](https://github.com/alattis/ALRadial)
...
## [AMAttributedHighlightLabel](https://github.com/rootd/AMAttributedHighlightLabel)
A UILabel subclass with mention/hashtag/link highlighting.
## [AmazeKit](https://github.com/detroit-labs/AmazeKit)
AmazeKit is a library for rendering beautiful images in your iOS app.
## [AmazonSDB](https://github.com/barrettj/AmazonSDB)
...
## [AMOptionMenu](https://github.com/amrox/AMOptionMenu)
A popup button/menu that allows selection of multiple options.
## [AMRatingControl](https://github.com/amseddi/AMRatingControl)
...
## [AMSlideOutController](https://github.com/andreamazz/SlideOutNavigation)
SlideOut Navigation Controller for iOS. Fully customizable.
## [Analytics](https://segment.io/libraries/ios-osx)
Segment.io Analytics library for iOS and OSX.
## [ANSegmentedControl](https://github.com/Decors/ANSegmentedControl)
Reader for Mac like Animation NSSegmentedControl.
## [AnyJSON](https://github.com/mattt/AnyJSON)
Encode / Decode JSON by any means possible.
## [Appacitive-iOS-SDK](https://github.com/aliHafizji/Appacitive-iOS-SDK)
...
## [Appirater](http://arashpayan.com/blog/2009/09/07/presenting-appirater/)
A utility that reminds your iPhone app's users to review the app.
## [AppleCoreAudioUtilityClasses@thehtb](https://github.com/thehtb/AppleCoreAudioUtilityClasses)
...
## [ARCMacro](https://gist.github.com/2823399)
...
## [ARGenericTableViewController](https://github.com/arconsis/ARGenericTableViewController)
iOS component to configure TableViews.
## [ARSafeJSON](https://bitbucket.org/antoine_r/arsafejson)
ARSafeJSON is a small library that will strip all occurences of NSNull from a JSON of any depth.
## [ARTableViewPager](https://github.com/arconsis/ARTableViewPager)
The ARTableViewPager is an iOS component for horizontal table view scrolling/paging.
## [ASCoalescingOperationQueue](https://github.com/appscape/ASCoalescingOperationQueue)
A dispatch queue where you only ever have one block queued.
## [Ashton](https://github.com/IdeasOnCanvas/Ashton)
...
## [ASStarRatingView](https://github.com/yggg/ASStarRatingView.git)
ASStarRatingView is a control to rating with stars, it is simple to use and configurable.
## [AsyncSenTest](https://github.com/rharriso/AsyncSenTest)
Asynchronous Test for OCTest (SenTest).
## [AsyncTestSupporter](https://github.com/yaakaito/AsyncTestSupporter)
...
## [AURosetteView](https://github.com/emilwojtaszek/AURosetteView)
...
## [AWVersionAgent](https://github.com/appwilldev/AWVersionAgent)
Check and notify user that new version is available from Local Notification.
## [AYNetworking](https://github.com/jboehler/AYNetworking)
AYNetworking is a API extension of AFNetworking.
## [AZAppearanceKit](https://github.com/zwaldowski/AZAppearanceKit)
...
## [BackInMotion](http://github.com/farcaller/BackInMotion)
RubyMotion helper classes for Objective-C.
## [Baidu-Analytics-SDK](http://mtj.baidu.com/)
Baidu mobile tongji analytics SDK for iOS.
## [Base32](http://github.com/ekscrypto/Base32)
...
## [Bazaarvoice](http://developer.bazaarvoice.com)
...
## [BBGroover](https://github.com/pwightman/BBGroover)
...
## [BDToastAlert](https://github.com/norsez/BDToastAlert)
...
## [BeamMusicPlayerViewController](https://github.com/BeamApp/MusicPlayerViewController)
An iPhone view controller to visualize and control music playback.
## [BeeDebugger](http://bbs.whatsbug.com)
...
## [BeeFramework](http://bee-framework.com)
...
## [BetterBlocks](https://github.com/neilco/BetterBlocks)
Completion and Error blocks for NSURLConnection.
## [BFCropInterface](https://github.com/nicholjs/BFCropInterface)
A better crop tool for iOS.
## [BHTabBar](https://github.com/fictorial/BHTabBar)
A web-browser like tab bar implementation for iOS4+.
## [Bindings](https://github.com/rdavies/Bindings)
A lightweight iOS library inspired by Cocoa Bindings.
## [Bitlyzer](https://github.com/albertodebortoli/Bitlyzer)
Class to shorten URLs with Bit.ly on iOS (both block based and delegate based using ARC).
## [BJImageCropper](http://www.barrettj.com)
...
## [BJRangeSliderWithProgress](https://github.com/barrettj/BJRangeSliderWithProgress)
...
## [BlockRSSParser](https://github.com/tiboll/BlockRSSParser)
...
## [BMXSwitch](https://github.com/mbigatti/BMXSwitch)
Image based replacement for UISwitch.
## [boost](http://www.boost.org)
Boost provides free peer-reviewed portable C++ source libraries.
## [BOSImageResizeOperation](https://github.com/BucketOSoftware/BOSImageResizeOperation)
An Objective-C operation to resize your images correctly and quickly.
## [BotKit](https://github.com/thoughtbot/BotKit)
BotKit is a Cocoa Touch static library for use in iOS projects.
## [box-ios-sdk](https://github.com/box/box-ios-sdk)
An Objective-C library for using the box API.
## [box2d](http://www.cocos2d-iphone.org)
...
## [BPFoundation](https://github.com/brianpartridge/BPFoundation)
All the things that Foundation should have, but doesn't.
## [BPKit](https://github.com/NSBoilerplate/BPKit)
A library of boilerplate actions for use in conjunction with NSBoilerplate.com templates.
## [BPPhotoLibrarian](https://github.com/brianpartridge/BPPhotoLibrarian)
Simple helpers for accessing the iOS photo library.
## [BPStatusBar](https://github.com/brianpartridge/BPStatusBar)
A utility class for displaying status updates in the iOS status bar.
## [BPXLUUIDHandler](https://github.com/blackpixel/BPXLUUIDHandler)
Library to encapsulate all the handling of getting/storing the new UUID.
## [Braille](https://github.com/rdavies/Braille)
A collection of Objective-C classes and extensions used for finding and handling accessibility elements.
## [Brightcove-Video-Cloud-App-SDK-MediaAPI](http://support.brightcove.com/en/video-cloud/docs/video-cloud-app-sdk-ios)
The Media API component of the Brightcove Video Cloud App SDK for iOS.
## [Brightcove-Video-Cloud-App-SDK-Player-and-Sharing-Kit](http://support.brightcove.com/en/video-cloud/docs/video-cloud-app-sdk-ios)
The Player and Sharing Kit component of the Brightcove Video Cloud App SDK for iOS.
## [Brightcove-Video-Cloud-Player-SDK](http://support.brightcove.com/en/video-cloud/docs/brightcove-video-cloud-player-sdk-ios/)
Brightcove Video Cloud Player SDK for iOS.
## [BrynKit](http://brynbellomy.github.com/BrynKit)
...
## [Caboodle](https://github.com/rdavies/Caboodle)
...
## [Calabash-server](https://github.com/calabash/calabash-ios-server)
Calabash is an automated testing technology for Android and iOS native and hybrid applications.
## [CameraPlusIntegration](http://api.camerapl.us/app-api)
Using the Camera+ app integration API, developers can integrate Camera+ functionality into their apps.
## [CaptureRecord](http://www.capturerecord.com)
...
## [CaulySDK](https://github.com/youknowone/CaulySDK)
Cauly SDK with helper.
## [CBIntrospect](https://github.com/cbess/CBIntrospector)
...
## [CCFScrollingTabBar](https://github.com/cocoa-factory/CCFScrollingTabBar)
A refined scrolling tab bar for iPhone.
## [CCNode-SFGestureRecognizers](http://merowing.info)
GestureRecognizers support for cocos2d, add UIGestureRecognizers to CCNode's.
## [cdebug](https://github.com/youknowone/cdebug)
...
## [CDEvents](http://rastersize.github.com/CDEvents)
An Objective-C wrapper for Mac OS X’s FSEvents C API.
## [CDPlistManager](https://github.com/Nuclominus/FileManager)
Objective-c class for working with plist.
## [CDZLinkOpenManager](https://github.com/cdzombak/CDZLinkOpenManager)
...
## [CedarAsync](https://github.com/cppforlife/CedarAsync)
...
## [CEPopupPickerView](https://github.com/chriseidhof/CEPopupPickerView)
...
## [ChartboostSDK](https://chartboost.com/)
...
## [ChromaHash](https://github.com/zdavison/iOSChromaHash.git)
A port of Matt Thompsons ChromaHash JS secure password field.
## [CIALBrowser](https://github.com/sylverb/CIALBrowser)
A MobileSafari like open source implementation.
## [CIOAPIClient](https://github.com/contextio/contextio-ios)
API Client for Context.IO.
## [CJImageMerge](https://github.com/batosai/CJImageMerge)
UIImage category for merge two images.
## [CJInfinityScroll](https://github.com/batosai/CJInfinityScrollTableViewController)
Infinityscroll in iOS.
## [CJRouter](http://batosai.github.com/CJRouter/)
Scheme url for iOS. Parsing URL and launch an application on a specified controller.
## [CJString](https://github.com/batosai/CJString)
...
## [CMHTMLView](https://github.com/mureev/CMHTMLView)
...
## [CocoaSecurity](https://github.com/kelp404/CocoaSecurity.git)
Encrypt/Decrypt: AES. Hash: MD5, SHA(SHA1, SHA224, SHA256, SHA384, SHA512). Encode/Decode: Base64, Hex.
## [CocoaSoundCloudAPI](https://github.com/soundcloud/CocoaSoundCloudAPI)
A simple way to interact with the SoundCloud  CocoaSoundCloudAPI.
## [CocoaSoundCloudUI](https://github.com/soundcloud/CocoaSoundCloudUI)
...
## [ColorArt](https://github.com/fleitz/ColorArt)
iTunes 11-style color matching code.
## [ColorPopover](https://github.com/gazolla/ColorPopover)
ColorPopover is a simple component for iOS that provides a "Popover" color picker.
## [Colours](http://subvertapps.com)
100s of beautiful, predefined UIColors and UIColor methods.
## [CommonCrypto](https://github.com/AlanQuatermain/aqtoolkit)
...
## [CSLinearLayoutView](https://github.com/scalessec/CSLinearLayoutView)
...
## [DDPageControl](https://github.com/ddeville/DDPageControl)
...
## [DDQuicklookAdditionalViews](https://github.com/Daij-Djan/QuicklookAdditionalViews)
An extension for the OSX cocoa class QLPreviewPanel. The Category allows to set additional views in the titlebar.
## [DDURLParser](https://github.com/doukasd/iOS-Components)
Parses Parameters in URLs.
## [DEFacebookComposeViewController](https://github.com/sakrist/FacebookSample)
...
## [DerpKit](http://github.com/amazingsyco/DerpKit)
...
## [DHCOnDealloc](https://github.com/confidenceJuice/DHCOnDealloc)
A simple category that allows you set a block to fire when an object is dealloced..
## [DHCShakeNotifier](https://github.com/confidenceJuice/DHCShakeNotifier)
A very simple category that sends out an NSNotification whenever the device is shaken.
## [DirectoryWatchdog](https://github.com/graetzer/DirectoryWatchdog)
...
## [DIYAssetPicker](https://github.com/dongle/AssetPicker)
...
## [DIYConduit](https://github.com/thisandagain/conduit)
JS to Objective-C... and back again.
## [DIYJazzHands](https://github.com/diy/jazzhands)
Scratch-off images like woah.
## [DLCImagePickerController](www.backspac.es)
...
## [DLStarRating](https://github.com/dlinsin/DLStarRating)
iOS star rating component.
## [DLSubclassAwareSingleton](https://github.com/regexident/DLSubclassAwareSingleton)
Singleton pattern implementation with support for specific instances per subclass.
## [DMActivityInstagram](https://github.com/coryalder/DMActivityInstagram)
...
## [DMInspectorPalette](https://github.com/malcommac/DMInspectorPalette)
...
## [DMLogFormatter](https://github.com/devmob-DE/CocoaLumberjack-DMLogFormatter)
...
## [DoneCancelNumberPadToolbar](https://github.com/broderboy/iphone-DoneCancelNumberPadToolbar)
...
## [DPHue](https://github.com/danparsons/DPHue)
...
## [DPSetupWindow](https://github.com/danpalmer/DPSetupWindow)
...
## [EDColor](https://github.com/thisandagain/color)
...
## [EDStorage](https://github.com/thisandagain/storage)
...
## [EZForm](https://github.com/chrismiles/EZForm)
...
## [FRCoreDataOperation](https://github.com/veritech/FRCoreDataOperation)
...
## [Google-API-Client](http://code.google.com/p/google-api-objectivec-client)
...
## [Google-Diff-Match-Patch](http://http://code.google.com/p/google-diff-match-patch/)
...
## [google-plus-ios-sdk](https://developers.google.com/+/mobile/ios/getting-started)
...
## [GoogleAnalytics-iOS-SDK](https://developers.google.com/analytics/devguides/collection/ios/v2/)
...
## [GoogleMapsDirection](https://github.com/Djengo/GoogleMapsDirection)
Wrapper around GoogleMaps Direction API.
## [GoogleMapsKit](http://blog.fawkeswei.com/2012/12/17/googlemapskit-launch-google-maps-for-iphone-from-your-app/)
...
## [GPUImage@siuying](https://github.com/BradLarson/GPUImage)
Versioned fork of GPUImage. OpenGL ES 2-based image and real-time camera filters for iOS.
## [GPXParser](https://github.com/fousa/gpx-parser-ios)
...
## [GrannySmith](https://github.com/hulu/GrannySmith)
...
## [GSAnimationBlockDelegate](https://github.com/MartinMoizard/GSAnimationBlockDelegate)
...
## [GSDropboxActivity](http://goosoftware.github.com)
An iOS 6 UIActivity subclass implementing uploads to Dropbox – as used in Zippity.app.
## [GSRadioButtonSetController](http://goosoftware.github.com/)
A controller for implementing radio buttons in Cocoa.
## [gtm-oauth](http://code.google.com/p/gtm-oauth)
...
## [GTMHTTPFetcher](https://code.google.com/p/gtm-http-fetcher)
...
## [GVCache](https://github.com/gangverk/GVCache)
Fast Caching for Objective-C (iPhone & Mac Compatible).
## [GVMusicPlayerController](https://github.com/gangverk/GVMusicPlayerController)
...
## [GZIP](https://github.com/rcdilorenzo/GZIP)
GZip Compression / Decompression for NSData.
## [Handsy](https://github.com/rdavies/Handsy)
...
## [HashBuilder](https://github.com/levigroker/HashBuilder)
...
## [ImageCache](https://github.com/tonyzonghui/ImageCache.git)
Basic image cache. For caching image into memory or disk.
## [IMAPClient](https://github.com/bcoe/IMAPClient)
An asynchrounous IMAP client for iOS.
## [IMOAutocompletionViewController](https://github.com/fredericcormier/IMOAutocompletionViewController)
...
## [InfColorPicker](https://github.com/InfinitApps/InfColorPicker)
...
## [Inflections](https://github.com/adamelliot/Inflections)
...
## [Injective](http://farcaller.github.com/Injective/)
...
## [Inline](https://github.com/rdavies/Inline)
Simplifies integration of testing frameworks with Xcode and SenTestingKit.
## [InMobiSDK](https://github.com/youknowone/InMobiSDK)
InMobi iOS SDK.
## [InnerBand](https://github.com/ZaBlanc/InnerBand)
A set of classes, macros, components and constants that speed up development.
## [iNotify](http://www.charcoaldesign.co.uk/source/cocoa#inotify)
...
## [InputToolbar](https://github.com/brandonhamilton/inputtoolbar)
Messages style input toolbar for iOS.
## [instagram-ios-sdk](http://www.followgram.me)
...
## [JCAutocompletingSearch](https://github.com/jcoleman/JCAutocompletingSearch)
...
## [KeenClient](https://github.com/keenlabs/KeenClient-iOS)
...
## [KFAppleScriptHandlerAdditions](http://homepage.mac.com/kenferry/software.html)
...
## [KFData](https://github.com/kylef/KFData)
Lightweight Core Data wrapper.
## [KGDiscreetAlertView](https://github.com/kgn/KGDiscreetAlertView)
...
## [KGNoise@tonyzonghui](https://github.com/tonyzonghui/KGNoise.git)
...
## [KHGravatar](https://github.com/kcharwood/KHGravatar)
...
## [KJGridLayout](https://github.com/kristopherjohnson/KJGridLayout)
...
Gridview for iOS.
## [KKPasscodeLock](https://github.com/aporat/KKPasscodeLock.git)
KKPasscodeLock is an iOS toolkit for adding a passcode view controller and passcode settings in ios apps.
## [KLExpandingSelect](http://www.cocoacontrols.com/platforms/ios/controls/klhorizontalselect)
...
## [KLHorizontalSelect](http://www.cocoacontrols.com/platforms/ios/controls/klhorizontalselect)
...
## [KLNoteViewController](http://www.cocoacontrols.com/platforms/ios/controls/klnoteviewcontroller)
...
## [KOKeyboard](https://github.com/adamhoracek/KOKeyboard)
...
## [KOTabs](https://github.com/adamhoracek/KOTabs)
...
To see the component in action, take a look at the video at http://www.becomekodiak.com/ or try our app called Kodiak PHP on the App Store.
## [KOTree](https://github.com/adamhoracek/KOTree)
KOTree allows you to show a tree of hierarchical data, e.g. files and folders.
It was developed for Kodiak PHP, an app which allows you to write and run PHP code directly on the iPad.
## [Krooshal](http://www.krooshal.com)
Krooshal keeps your app running like new.
## [KSADNTwitterFormatter](https://github.com/Keithbsmiley/KSADNTwitterFormatter)
...
## [KSCrypto](https://github.com/karelia/KSCrypto)
Simple wrapper for sha1 hashing files/data.
## [KSCustomUIPopover](http://www.scianski.com)
...
## [KSGithubStatusAPI](https://github.com/Keithbsmiley/KSGithubStatusAPI)
A simple Objective-C API controller for status.github.com.
## [KSInstapaperAPI](https://github.com/Keithbsmiley/KSInstapaperAPI)
An Instapaper API controller with the ability to queue URLs when the network is down.
## [KSLabel](https://github.com/Keithbsmiley/KSLabel)
...
## [KTOneFingerRotationGestureRecognizer](https://github.com/kirbyt/KTOneFingerRotationGestureRecognizer)
...
## [KVPasscode](http://github.com/Koolistov/Passcode)
...
## [KWFontPicker](https://github.com/kawanet/KWFontPicker)
...
## [LARSAdController](http://larsacus.github.com/LARSAdController/)
...
## [LetterpressExplosion](https://github.com/vibrazy/letterpressexplosion)
...
## [LibComponentLogging-Core](http://0xc0.de/LibComponentLogging)
...
## [LibComponentLogging-Crashlytics](https://github.com/CenterDevice/LibComponentLogging-Crashlytics)
...
## [LibComponentLogging-LogFile](http://0xc0.de/LibComponentLogging)
...
## [LibComponentLogging-NSLog](http://0xc0.de/LibComponentLogging)
...
## [LibComponentLogging-NSLogger](http://0xc0.de/LibComponentLogging)
...
## [LibComponentLogging-qlog](http://0xc0.de/LibComponentLogging)
...
## [LibComponentLogging-SystemLog](http://0xc0.de/LibComponentLogging)
...
## [LibComponentLogging-UserDefaults](http://0xc0.de/LibComponentLogging)
...
## [libechonest](https://github.com/echonest/libechonest)
Objective-C Library for The Echo Nest API.
## [libetpan](https://github.com/dinhviethoa/libetpan)
...
libhangul.
## [libintl-alternative](https://github.com/youknowone/libintl-alternative)
...
## [libPhoneNumber-iOS](https://github.com/me2day/libPhoneNumber-iOS)
...
## [Localytics-iOS-Client](http://www.localytics.com/docs/)
Localytics is built for mobile & tablet apps. Integration is easy, takes just 10 minutes and requires only a few lines of code. A quick integration allows you to track all standard metrics such as platform, device type, sessions and unique users. Event and screen tracking are used to analyze conversion funnels, screen flows, feature usage, content access, advertising performance, etc. Full support for iOS, Android, BlackBerry, Windows Phone and HTML5 apps.
...
## [LOG_EXPR](http://atelierdumobile.com)
...
## [LRImageManager](https://github.com/luisrecuenco/LRImageManager.git)
Objective-C simple image manager with memory and disk cache support.
## [LRMocky](http://github.com/lukeredpath/LRMocky)
...
## [LRResty](http://projects.lukeredpath.co.uk/resty/)
Resty is a simple to use HTTP library for Cocoa and iOS apps, aimed at consuming RESTful web services and APIs.
## [LRTableModel](https://github.com/lukeredpath/LRTableModel)
A JTable-inspired alternative way of modelling your table view data.
## [LRTVDBAPIClient](https://github.com/luisrecuenco/LRTVDBAPIClient.git)
Objective-C wrapper for TheTVDB.
## [ltools](https://github.com/percysnoodle/ltools)
...
## [LTUpdate](https://github.com/lexrus/LTUpdate)
LeT'sUpdate to the new version available in the AppStore.
## [lua](https://github.com/qmx/lua)
The lua language (for embedding).
## [LUKeychainAccess](https://github.com/TheLevelUp/LUKeychainAccess)
A wrapper for iOS Keychain Services that behaves just like NSUserDefaults.
## [LXPagingViews](https://github.com/lxcid/LXPagingViews)
...
## [MABToolkit](https://github.com/iloveitaly/MABCocoaToolkit)
...
## [MACollectionUtilities](https://github.com/mikeash/MACollectionUtilities)
...
## [MASShortcut](http://blog.shpakovski.com/2012/07/global-keyboard-shortcuts-in-cocoa.html)
...
## [MasterShareSDK](https://github.com/Zarph/MasterShareSDK)
...
## [MBCategory](https://github.com/ekdevdes/MBCategory)
...
## [MBProgressHUD](http://www.bukovinski.com)
MBProgressHUD is an iOS drop-in class that displays a translucent HUD 
with an indicator and/or labels while work is being done in a background thread. 
The HUD is meant as a replacement for the undocumented, private UIKit UIProgressHUD 
with some additional features.
## [MBPullDownController](http://www.bukovinski.com)
...
## [MDAboutController](http://mochidev.com/open)
Automatically populated about view controller for iOS apps.
## [MDCFocusView](https://github.com/modocache/MDCFocusView)
Apply a "tutorial screen" overlay to your application window.
## [MDCParallaxView](https://github.com/modocache/MDCParallaxView)
Create a parallax effect using a custom container view, much like the top view of Path's timeline.
## [MDCScrollBarLabel](https://github.com/modocache/MDCScrollBarLabel)
...
## [MendeleySDK](https://github.com/shazino/MendeleySDK)
...
## [MFCache](https://github.com/mkftr/MFCache)
A lightweight iOS cache class.
## [MFFadeBackModalAnimation](https://github.com/mikefrederick/MFFadeBackModalAnimation)
...
## [MFLicensing](https://github.com/freshcode/MFLicensing)
...
## [MGBenchmark](https://github.com/MattesGroeger/MGBenchmark)
This library provides an easy way to measure execution time in code.
## [MGBox](https://github.com/sobri909/MGBox)
...
## [MHKitchenSink](https://github.com/bobjustbob/MHKitchenSink)
Lots of cool iOS classes globbed together in one (soon-to-be) mega repository. Initial version.
## [MHPrettyDate](https://github.com/bobjustbob/MHPrettyDate)
An iOS framework that provides a simple mechanism to get  "Pretty Dates" ("Yesterday", "Today", etc.) from NSDate objects.
## [MHTabBarController](http://www.hollance.com/2011/11/mhtabbarcontroller-a-custom-tab-bar-for-ios-5-using-the-new-container-apis/)
...
## [MIHGradientView](http://github.com/hohl/MIHGradientView)
UIView subclass which draws a color gradient as background.
## [MIHSliderView](http://github.com/hohl/MIHSliderView)
...
## [MixiSDK](http://developer.mixi.co.jp/connect/mixi_graph_api/ios/)
mixi SDK for iOS.
...
## [MKFoundation](https://github.com/MugunthKumar/MKFoundation)
Super easy serialization/deserialiation classes for JSON/XML and Parse.
## [MKHorizMenu](http://blog.mugunthkumar.com/coding/ios-control-mkhorizmenu/)
...
## [MKInfoPanel](http://blog.mugunthkumar.com/coding/ios-code-tweetbot-like-alertpanels/)
Non-modal, non-intrusive Info Panel implementation as seen on some "popular" apps.
## [MKMapView+AttributionView](https://github.com/bartvandendriessche/MKMapView-AttributionView)
A MKMapView category that adds a method to obtain the AttributionView.
## [MKMapViewZoom](http://troybrant.net/blog/2010/01/set-the-zoom-level-of-an-mkmapview/)
...
## [MKReachableOperationQueue](https://maxkramer.co)
...
## [MLScreenshot](https://github.com/mRs-/MLScreenshot)
Get a screenshot from UIView easy as pie.
## [MLUIColorAdditions](https://github.com/mRs-/MLUIColorAdditions)
Additions for UIColor for easy handling with hex- and rgb-colors.
## [MMCounterView](https://github.com/mmccroskey/MMCounterView)
...
## [MOOMaskedIconView](https://github.com/peyton/MOOMaskedIconView)
...
## [MTAnimatedLabel](https://github.com/mturner1721/MTAnimatedLabel)
MTAnimatedLabel is a UILabel subclass that supports animated text similar to the iPhone/iPad lock screen.
## [MTBlockAlertView](https://github.com/mysterioustrousers/MTBlockAlertView)
An iOS Alert View that uses block-based delegation instead of protocols.
## [MTBlockTableView](https://github.com/mysterioustrousers/MTBlockTableView)
A table view that uses blocks instead of protocols. Try it, we dare you.
## [MTCollectionOperators](https://github.com/mtrudel/MTCollectionOperators)
...
operations.
## [MTColorDistance](https://github.com/mysterioustrousers/MTNearestColor)
A category on UIColor. Pass in an array of colors and it will return the closest color to the receiver.
## [MTControl](https://github.com/mysterioustrousers/MTControl)
Attach block handlers to UIControl objects jQuery style.
## [MTDateComponentsPicker](https://github.com/mysterioustrousers/MTDateComponentsPicker)
...
## [MTFittedScrollView](https://github.com/mysterioustrousers/MTFittedScrollView)
A UIScrollView subclass that resizes itself to fit around its content.
## [MTGeometry](https://github.com/mysterioustrousers/MTGeometry)
An extension to Core Graphics Geometry. Intersections, scaling, etc.
## [MTJSONDictionary](https://github.com/mysterioustrousers/MTJSONDictionary.git)
An NSDictionary category for when you're working with it converting to/from JSON. DEPRECATED, use MTJSONUtils instead.
## [MTJSONUtils](https://github.com/mysterioustrousers/MTJSONUtils.git)
...
## [MTLocation](https://github.com/myell0w/MTLocation)
...
## [MTMultipleViewController](https://github.com/mtrudel/MTMultipleViewController)
...
## [MTQueue](https://github.com/mysterioustrousers/MTQueue)
...
## [MTStackableNavigationController](https://github.com/mtrudel/MTStackableNavigationController)
...
## [MTStackViewController](https://github.com/willowtreeapps/MTStackViewController)
...
## [MTZoomWindow](https://github.com/myell0w/MTZoomWindow)
...
## [MYUtilities](https://github.com/snej/MYUtilities)
...
## [NBSoundCloudActivity](https://github.com/nbonatsakis/NBSoundCloudActivity)
A UIActivity subclass for SoundCloud sharing.
## [NCChineseConverter](https://github.com/nickcheng/NCChineseConverter)
NCChineseConverter is an Objective-C based chinese coverter for converting between Hans and Hant.
## [NCCWL](https://github.com/nickcheng/NCCWL)
...
## [NGVaryingGridView](https://github.com/NOUSguide/NGVaryingGridView)
A GridView which allows to set individual Rects for the Cells.
## [NICInfo](https://bitbucket.org/kenial/nicinfo/overview)
...
## [NLKit](https://github.com/jksk/NLKit)
A collection of categories and classes to simplify iOS development.
## [NLTHTTPStubServer](http://github.com/yaakaito/NLTHTTPStubServer)
NLTHTTPStubServer is mocking server. launch simple HTTPServer on Testcodes.
## [NLTQuickCheck](http://github.com/yaakaito/NLTQuickCheck)
...
## [Novocaine](http://alexbw.github.com/novocaine/)
Painless high-performance audio on iOS and Mac OS X.
## [NPReachability](https://github.com/Abizern/NPReachability)
Reachability without the suck.
## [NSArray+Functional](https://github.com/grav/nsarray-functional)
ObjC category that adds functional programming methods to NSArray.
## [NSAssert+BackingActions](https://github.com/insanehunter/NSAssert-BackingActions)
NSAssert-based macros that perform some backing actions when NS_BLOCK_ASSERTIONS is defined.
## [NSBKeyframeAnimation](https://github.com/NachoSoto/NSBKeyframeAnimation)
...
## [NSClippy](http://weiranzhang.com/NSClippy)
Clippy, your office friend, for iOS.
## [NSContainers-PrettyPrint](https://github.com/NSError/NSContainers-PrettyPrint)
...
Base64 for NSData.
## [NSData+MD5Digest](https://github.com/siuying/NSData-MD5)
...
## [NSDate-Extensions](http://ericasadun.com)
Practical real-world dates.
## [NSDate-TimeDifference](https://github.com/ootake/NSDate-TimeDifference/)
Returns a string with the elapsed time from the current time.
## [NSDate-TKExtensions](https://github.com/mapedd/NSDate-TKExtensions)
Set of usefull categories for NSDate.
## [NSDictionary+TRVSUnderscoreCamelCaseAdditions](https://github.com/travisjeffery/NSDictionary-TRVSUnderscoreCamelCaseAdditions)
Convert NSDictionary keys to/from under_score/camelCase. Useful when working with JSON APIs, etc.
## [NSEnumeratorLinq](https://github.com/k06a/NSEnumeratorLinq)
...
## [NSLogger-CocoaLumberjack-connector](https://github.com/steipete/NSLogger-CocoaLumberjack-connector)
...
## [NSMutableArrayRearrangingExtensions](https://github.com/yaakaito/NSMutableArrayRearrangingExtensions)
...
## [NSRemoteLog](https://github.com/gscalzo/NSRemoteLog)
A delightful remote NSLogging library.
## [NSString+RMURLEncoding](http://gir/NSString+RMURLEncoding)
Adds URL encoding helpers to NSString.
## [NSString+TextAndNumberValidation](http://github.com/mapedd/NSString-TextAndNumberValidation)
...
## [NSString-HTML](https://github.com/Koolistov/NSString-HTML)
...
## [NSUnit](https://github.com/jacksonh/NSUnit)
...
## [NSURLConnection-Blocks](https://github.com/RuiAAPeres/NSURLConnection-Blocks)
...
## [NSUUID](https://github.com/0xced/NSUUID)
NSUUID implementation for iOS < 6.0 and OS X < 10.8.
## [NSView+LinenBackground](https://bitbucket.org/i386/nsview-linenbackground/)
Draw the standard linen background on any NSView.
## [NSXtensions](https://github.com/shoumikhin/NSXtensions)
...
## [NVSlideMenuController](https://github.com/nverinaud/NVSlideMenuController)
...
## [NXActivities](https://github.com/nxtbgthng/NXActivities)
...
## [objc-simple-bindings](http://github.com/mruegenberg/objc-simple-bindings)
A simple iOS compatible bindings mechanism for Objective-C.
## [ObjC-StatelyNotificationRobot](http://brynbellomy.github.com/ObjC-StatelyNotificationRobot)
NSNotification wrapper that keeps track of state and notifies new observers of state immediately.
## [objc-utils](https://github.com/mruegenberg/objc-utils)
...
A header file with macros that synthesize accessors for 
    ...
    a breeze.
## [ObjectAL-for-iPhone](http://kstenerud.github.io/ObjectAL-for-iPhone/)
Mac and iOS Audio, minus the headache.
## [Objection](http://www.objection-framework.org)
A lightweight dependency injection framework for Objective-C.
## [Objective-C-HMTL-Parser](http://www.benreeves.co.uk)
...
Objective Git provides Objective-C bindings to the libgit2 linkable C Git library.
This library follows the rugged API as close as possible while trying to maintain a native objective-c feel.
## [ObjectiveLibModbus](https://github.com/iUtvikler/ObjectiveLibModbus)
...
## [ObjectiveLuhn](https://github.com/MaxKramer/ObjectiveLuhn)
The Luhn Algorithm ported to objective-c.
## [ObjectiveMetrics](https://github.com/jorgenpt/ObjectiveMetrics)
Implementation of DeskMetrics for iOS & OS X.
## [ObjectiveMixin](https://github.com/vl4dimir/ObjectiveMixin)
Ruby-like mixin functionality for Objective-C programs.
## [ObjectiveRecord](https://github.com/mneorr/Objective-Record)
...
## [ObjectiveTumblr](https://github.com/IgnitionSoft/ObjectiveTumblr)
Tumblr API Client for Objective-C with minimal features, based on Tumblr API v2 (OAuth).
## [ObjectXML](https://github.com/youknowone/ObjectXML)
Simple XML object model for Objective-C from NSXMLParser.
## [ObjQREncoder](https://github.com/jverkoey/ObjQREncoder)
...
## [OCCalendar](https://github.com/ocrickard/OCCalendar)
...
## [OCLogTemplate](https://github.com/jasperblues/OCLogTemplate)
A logging framework for Objective-C projects.
## [OCMapView](https://github.com/XBeg9/OCMapView)
...
## [OCTotallyLazy](https://github.com/stuartervine/OCTotallyLazy)
...
## [ODIN](http://code.google.com/p/odinmobile/)
...
## [OEGFlamingJune](https://github.com/ankor/OEGFlamingJune)
Models for REST web services using AFNetworking.
## [OGImage](http://github.com/origamilabs/OGImage)
...
## [OLImageView](https://www.github.com/ondalabs/OLImageView)
Animated GIFs implemented the right way.
## [Omazing](https://github.com/yzlin/Omazing)
An amazing kit with a bunch of cool functions written for Cocoa.
## [OMGFramework](https://github.com/Vaseltior/OMGFramework)
...
Ooyala for iOS.
## [OpenCV](https://github.com/Fl0p/OpenCV-iOS)
...
## [OROpenSubtitleDownloader](https://github.com/orta/OROpenSubtitleDownloader)
...
## [Overline-BlocksKit](https://github.com/yaakaito/Overline)
Overline with BlocksKit.
## [OZTabBarController](https://github.com/chakrit/oztabbarcontroller)
Lightweight tab bar controller geared for maximum customizability.
## [PagedFlowView](https://github.com/fictorial/PagedFlowView)
Fictorial's fork adds extra delegate methods; also see homepage for example which uses UIPageControl.
## [PanicAR](http://github.com/doPanic/PanicAR)
...
## [PaperFold](http://www.honcheng.com/2012/07/PaperFold-for-iOS)
...
## [PaperFoldMenuController](http://www.honcheng.com/2012/10/PaperFoldMenuController---a-folding-menu-navigation-controller)
...
## [Parcoa](https://github.com/brotchie/Parcoa)
...
## [PassSlot](http://www.passslot.com)
...
## [PayPal-iOS-SDK](https://developer.paypal.com/webapps/developer/docs/integration/mobile/ios-integration-guide/)
...
## [pegged](https://github.com/explicitcall/pegged)
...
## [PgMdAtom](https://pagemeld.com/code/PgMdAtom)
Complete ATOM parser for iOS.
## [PHFArrayComparator](https://github.com/fphilipe/PHFArrayComparator)
...
## [PHFRefreshControl](https://github.com/fphilipe/PHFRefreshControl)
...
## [PhoneNumberFormatter](http://github.com/edgecase/PhoneNumberFormatter)
NSFormatter subclass for formatting phone numbers.
## [PinEntry](https://github.com/farcaller/iphone-pinentry)
...
## [PivotalCoreKit](https://github.com/pivotal/PivotalCoreKit)
...
## [PlayHavenSDK](http://playhaven.com)
...
## [PLWeakCompatibility](https://github.com/plausiblelabs/PLWeakCompatibility)
Compatibility stubs to enable use of weak references with ARC on older OSes.
## [PMCalendar](https://github.com/kovpas/PMCalendar)
Yet another calendar component for iOS. Supports presenting as a popover and very flexible UI tuning.
## [PMPKVObservation](https://github.com/aufflick/PMPKVObservation)
...
## [PocketAPI](http://getpocket.com/developer/)
...
Pocket lists.
## [PocketChangeSDK](https://pocketchange.com)
Pocket Change SDK for universal in-app rewards.
## [PodioKit](https://developers.podio.com/clients/ios)
...
## [PostageKit](https://github.com/postageapp/postageapp-objc)
A Mac OSX / iOS API wrapper for the PostageApp transactional mail service.
## [PosterousObjC](https://github.com/joshgrenon/PosterousObjC)
ObjectiveC library for Posterous API.
## [POViewFrameBuilder](https://github.com/podio/ios-view-frame-builder)
...
## [PrettyKit](http://github.com/vicpenap/PrettyKit)
...
## [ProtobufObjC](http://code.google.com/p/metasyntactic/wiki/ProtocolBuffers)
An implementation of Protocol Buffers in Objective C.
## [PRTween](https://github.com/dominikhofmann/PRTween)
...
## [PSAlertView](https://github.com/steipete/PSAlertView)
...
## [PSMenuItem](https://github.com/steipete/PSMenuItem)
...
## [PSStoreButton](https://github.com/steipete/PSStoreButton)
...
## [PullToRefreshView](https://github.com/btaylor/PullToRefreshView)
A UIView for easily implementing pull-to-refresh functionality in a UIScrollView that doesn't suck.
## [PunchScrollView](https://github.com/tapwork/PunchScrollView)
PunchScrollView is a iOS ScrollView framework which works like the UITableView.
## [PWLoadMoreTableFooter](https://github.com/puttin/PWLoadMoreTableFooter)
...
## [QBImagePickerController](https://github.com/questbeat/QBImagePickerController)
A clone of the UIImagePickerController with multiple selection feature.
## [QBKOverlayMenuView](https://github.com/sendoa/QBKOverlayMenuView)
...
## [QuadCurveMenu](https://github.com/burtlo/QuadCurveMenu)
Path 2.0 menu (configurable, extendable, and composable).
## [Quantcast-Measure](https://www.quantcast.com/measurement/quantcast-measure-for-mobile-apps/)
...
## [Quantcast-Measure-iOS4](https://www.quantcast.com/measurement/quantcast-measure-for-mobile-apps/)
		Quantcast Measure available for iOS and Android mobile apps. The free service lets you to:
               * **Showcase Your App Stats** - Get the word out on your mobile app by showcasing your traffic on Quantcast – make your most accomplished metrics accessible to everyone.
* **Demonstrate User Loyalty to Brands** - Engaging with mobile audiences is essential to brand advertisers advertising in apps. Return usage metrics indicates how loyal your audience is: if users are coming back for more, brands can connect with them.
* **Understand Cross-Platform Visitation** - Get the complete picture. If you have a website, see the audience visitation patterns across your online, mobile web, and mobile app properties.
## [Quayboard](https://github.com/jellybeansoup/ios-quayboard)
A keyboard accessory that blends in with the default iOS keyboard.
## [QuickDialog](http://escoz.com/quickdialog)
...
## [QUnit.m](https://github.com/kmalakoff/QUnit.m/)
...
## [RangeSlider](http://buildmobile.com/wicked-ios-range-slider-part-one/)
Source code for the iOS Range Slider series by Mal Curtis at BuildMobile.
## [RAPageViewController](https://github.com/evadne/RAPageViewController)
...
## [RateStars](https://github.com/mcgtts/RateStars)
RateStars provides a rating view.
## [Raven](https://getsentry.com/)
...
## [RCLocationManager](http://rcabamo.github.com/RCLocationManager/)
...
## [RCPopoverView](http://robinchou.com)
...
## [ReactiveCocoa](https://github.com/blog/1107-reactivecocoa-is-now-open-source)
ReactiveCocoa offers:
...
## [REActivityViewController](https://github.com/romaonthego/REActivityViewController)
...
its visual part.
## [RECurtainViewController](https://github.com/romaonthego/RECurtainViewController)
A custom curtain-style transition for UIViewControllers.
## [REDebugClient](https://github.com/romaonthego/REDebugClient)
Advanced remote Xcode logging in Terminal app.
## [REFormattedNumberField](https://github.com/romaonthego/REFormattedNumberField)
...
## [REImageSprite](https://github.com/romaonthego/REImageSprite)
...
## [REMarkerClusterer](https://github.com/romaonthego/REMarkerClusterer)
...
## [REPhotoCollectionController](https://github.com/romaonthego/REPhotoCollectionController)
A simple photo thumbnail viewer for the iOS that groups photos by date.
## [RestKit](http://www.restkit.org)
RestKit is a framework for consuming and modeling RESTful web resources on iOS and OS X.
## [RESTMagic](http://www.RESTMagic.org)
...
## [RESwitch](https://github.com/romaonthego/RESwitch)
Open source alternative to UISwitch, customizable via UIAppearance protocol.
## [RETrimControl](https://github.com/romaonthego/RETrimControl)
Audio trim control, similar to the one seen in default iPhone Voice Memos app.
## [REVClusterMap](http://revolver.be/blog/mapkit-clustering-for-ios/)
...
## [RevMobSDK](http://sdk.revmob.com/ios.html)
RevMobSDK for showing ads, banners, more games link and many more.
## [RFKeychain](https://github.com/rheinfabrik/RFKeychain)
...
## [RHAdditions](https://github.com/heardrwt/RHAdditions)
...
## [RLPageControl](https://github.com/Me1000/RLPageControl)
...
## [RMShapedImageView](https://github.com/robotmedia/RMShapedImageView)
...
## [RouletteWheelCollectionViewLayout](https://github.com/kenshin03/RouletteWheelCollectionViewDemo)
Custom UICollectionViewFlowLayout subclass implementation of a roulette wheel of cards.
## [Routable](https://github.com/usepropeller/routable-ios)
...
## [RSActionSheet](https://github.com/rsilva/RSActionSheet)
...
## [RSSecrets](https://github.com/jeffargast/RSSecrets)
...
## [RubyCocoaString](https://github.com/pwightman/RubyCocoaString)
Ruby string manipulation methods as a category on NSString.
## [rump-ios](https://github.com/tpuronen/rump-ios)
...
## [RZCollectionList](http://github.com/Raizlabs/RZCollectionList)
...
## [SBSegmentedViewController](https://github.com/Scott90/SBSegmentedViewController)
Custom view controller container that uses a segmented control to switch between view controllers.
## [SBTickerView](https://github.com/blommegard/SBTickerView)
An easy to use ticker view with inspiration from Flipboard.
## [SCKit](https://github.com/mpurland/SCKit)
...
## [Sealant](https://github.com/blazingcloud/sealant)
This pod provides a set of utilities for automated testing on iOS.
## [SEBeamMeUpScotty](http://github.com/brynbellomy/SEBeamMeUpScotty)
Ridiculously simple iOS video uploader classes for YouTube, Facebook, etc.
## [SecureUDID](http://SecureUDID.org/)
...
## [SEDraggable](http://github.com/brynbellomy/iOS-DragAndDrop)
Drag and drop UIView subclasses for iOS.
## [SEEPhoneNumberFormatter](https://github.com/seesawco/SEEPhoneNumberFormatter)
Format phone numbers in Objective-C using libphonenumber.
## [SEFilterControl](https://github.com/ShadyElyaski/ios-filter-control)
An iOS Filter UIControl Subclass. Zero Graphics. Highly Customizable.
## [SEHumanizedTimeDiff](https://github.com/fictorial/SEHumanizedTimeDiff)
...
## [Seriously](https://github.com/probablycorey/seriously)
...
## [SESpringBoard](http://www.apperto.com)
...
## [SFObservers](https://github.com/krzysztofzablocki/SFObservers)
Categories expanding both NSNotificationCenter and KVO to provide auto removal of observers.
## [SFSocialFacebook](http://developers.facebook.com/docs/reference/iossdk)
...
## [SGBDrillDownController](https://github.com/percysnoodle/SGBDrillDownController)
A parent view controller for the iPad which manages a stack of controllers while keeping the top two controllers visible.
## [SGHotKeysLib](https://github.com/secondgear/SGHotKeysLib)
...
## [SHAccountManager](https://github.com/seivan/SHAccountManager)
...
## [SHAccountStore](https://github.com/seivan/SHAccountStore)
...
.
## [ShallWeAdSDK](https://github.com/youknowone/ShallWeAdSDK)
ShallWeAd SDK.
...
## [ShareThis](https://github.com/ign/ShareThis)
...
## [SHOmniAuth](https://github.com/seivan/SHOmniAuth)
...
## [Simple-KML](https://github.com/mapbox/Simple-KML)
Simple KML is a simple & lightweight parsing library for KML written in Objective-C for the iOS platform.
## [SimpleRemoteObject](https://github.com/halsk/SimpleRemoteObject)
SimpleRemoteObject is a simple Objectie-C library that can create your classes' instance from server-side JSON text.
## [SinaWeibo](https://github.com/mobileresearch/weibo_ios_sdk_sso-oauth)
sina weibo sdk of sso and Oauth2.0.
## [SinglySDK](https://github.com/Singly/iOS-SDK)
iOS SDK for Singly.
## [SJNotificationViewController](http://github.com/ekdevdes/SJNotificationViewController)
Lightweight notifications in iOS apps.
## [SKBindingManager](https://github.com/SlavkoKrucaj/SKBindingManager)
...
## [SKInnerShadowLayer](https://github.com/khanlou/SKInnerShadowLayer)
...
## [SLGlowingTextField](https://github.com/aaronbrethorst/SLGlowingTextField)
This is a very simple subclass of UITextField that is designed to look like a Bootstrap input field.
## [SlimeRefresh](https://github.com/dbsGen/SlimeRefresh)
SlimeRefresh looks like UIRefreshControl in iOS6, SlimeRefresh can also run on iOS4.0 and later...
## [SLObjectiveCRuntimeAdditions](https://github.com/OliverLetterer/SLObjectiveCRuntimeAdditions)
...
## [SMGridView](https://github.com/brewster/SMGridView)
...
## [SMXObject](https://github.com/simonmaddox/SMXObject)
NSObject subclass for doing interesting things.
## [Snapper](https://github.com/pilgrimagesoftware/Snapper)
An App.net client library for iOS and Mac.
## [SNRFetchedResultsController](https://github.com/indragiek/SNRFetchedResultsController)
Automatic Core Data change tracking for OS X (NSFetchedResultsController port).
## [SNRHUDKit](https://github.com/indragiek/SNRHUDKit)
...
## [SocialAccounts](https://github.com/aporat/SocialAccounts.git)
...
## [SOCKit](http://github.com/jverkoey/SOCKit)
...
## [SORelativeDateTransformer](https://github.com/billgarrison/SORelativeDateTransformer)
An NSValueTransformer subclass to turn an NSDate into a string expressing its relative age from now.
## [Sparrow-Framework](http://gamua.com/sparrow/)
...
## [Specify](https://github.com/rdavies/Specify)
...
## [spring-objective-c](https://github.com/jasperblues/Typhoon.git)
Has been renamed to Typhoon.
## [SPSuccinct](http://github.com/nevyn/SPSuccinct)
Making ObjC succinct: KVO tools including SPDepends, and macros for "POD" literals.
## [SPTabBarController](https://github.com/cpatni/SPTabBarController)
Custom tab bar container controller for iOS 5.
## [SQLCipher](http://sqlcipher.net)
SQLCipher is an open source extension to SQLite that provides transparent 256-bit AES encryption of database files.
## [sqlite3](http://www.sqlite.org)
SQLite is an embedded SQL database engine.
## [sqlite3-objc](https://github.com/youknowone/sqlite3-objc)
Sqlite3 Objective-C wrapper.
## [SRMonthPicker](https://www.github.com/simonrice/SRMonthPicker)
Like UIDatePicker, but without the days.
## [SSCheckBoxView](http://www.ardalahmet.com/2011/12/07/sscheckboxview-a-check-box-ui-control-for-ios-apps/)
...
## [SSPullToRefresh](https://github.com/samsoffes/sspulltorefresh)
...
## [STableViewController](https://github.com/shiki/STableViewController)
...
## [StackMobPush](http://stackmob.com)
StackMob's Push SDK for sending push notifications via the StackMob Services on iOS.
## [StandardPaths](https://github.com/nicklockwood/StandardPaths)
...
## [StateMachine-GCDThreadsafe](https://github.com/brynbellomy/StateMachine-GCDThreadsafe)
Threadsafe state machine library for Objective-C based on Grand Central Dispatch.
## [STLOAuth](https://github.com/Elland/stl-oauth-client)
...
## [StorageRoomKit](https://github.com/thriventures/StorageRoomKit)
...
## [StoreKISS](https://github.com/mishakarpenko/StoreKISS)
...
## [STScratchView](https://github.com/SebastienThiebaud/STScratchView)
...
## [SVHTTPRequest](http://samvermette.com/310)
...
## [SVStatusHUD](http://https://github.com/samvermette/SVStatusHUD)
A copycat of the HUD shown on orientation and volume change in iOS.
## [SVWebViewController](http://samvermette.com/173)
...
## [SWSnapshotStackView](https://github.com/snwau/SWSnapshotStackView)
...
## [SYCache](https://github.com/soffes/SYCache)
...
## [SYPaginator](https://github.com/Synthetic/SYPaginator)
...
## [SZNAltmetric](https://github.com/shazino/SZNAltmetric)
Objective-C client for the Altmetric API.
## [TapkuLibrary](http://tapku.com/)
...
## [taskit](https://github.com/fileability/taskit)
...
## [TBXML+NSDictionary](https://github.com/mackoj/TBXML-NSDictionary)
XML to NSDictionary through TBXML.
## [TBXMLPivotalForks](https://github.com/pivotalforks/TBXML)
...
## [TCAsyncHashProtocol](https://github.com/nevyn/TCAsyncHashProtocol)
...
## [Tesseract](https://github.com/ldiqual/tesseract-ios-lib)
Tesseract and Leptonica libraries compiled for iOS.
## [Tesseract-wrapper](https://github.com/ldiqual/tesseract-ios)
Tesseract-ios is an Objective-C wrapper for Tesseract OCR.
## [TestFlightLogger](https://github.com/abillingsley/TestFlightLogger)
A CocoaLumberjack logger for TestFlight.
## [TestFlightSDK](http://www.testflightapp.com)
TestFlightSDK for over-the-air beta testing and crash reporting.
## [TestPilot](https://github.com/itsthejb/TestPilot)
Unit-testing Cocoa just got easy.
## [TextExpander](http://smilesoftware.com/sdk)
Add TextExpander touch functionality to your iOS app!
## [TGJSBridge](https://github.com/ohsc/TGJSBridge)
...
## [theWrapper](https://github.com/tomersh/TheWrapper)
...
## [THObserversAndBinders](https://github.com/chriseidhof/THObserversAndBinders)
Easy, lightweight, object-based key-value observing and -binding.
## [Three20](http://three20.info/)
Three20 is an Objective-C library for iPhone developers.
## [Three20Lite](https://github.com/aporat/three20lite)
...
TimeScroller is an effort to reproduce the nifty view that hovers beside the
scroll bar in the Path app.
  
## [TimesSquare](https://github.com/square/objc-TimesSquare)
TimesSquare is an Objective-C calendar view for your apps.
## [Tin](https://github.com/pjaspers/Tin)
...
## [TKRoundedView](http://github.com/mapedd/TKRoundedView)
Rounded corners without images and much more.
## [TKSenTestAsync](https://github.com/xslim/TKSenTestAsync)
SenTest category with Asynchronous support.
## [TLSignals](https://github.com/bsideup/TLSignals)
Observer pattern with compile-time type checking for Objective-C.
## [TLTiltHighlightView](https://github.com/TeehanLax/TLTiltHighlightView)
A horizontal gradient which adjusts its appearance based on the positional attitude of an iOS device.
## [TLTiltSlider](https://github.com/TeehanLax/TLTiltSlider)
...
## [TMTumblrSDK](http://tumblr.github.com/TMTumblrSDK)
...
## [TownPlan](https://github.com/peterp/TownPlan)
...
## [TRAutocompleteView](https://github.com/TarasRoshko/TRAutocompleteView)
Flexible and highly configurable auto complete view, attachable to any UITextField.
## [treemapkit](http://github.com/yatsu/treemapkit)
...
## [TSLibraryImport](https://github.com/tapsquare/TSLibraryImport)
...
## [TTOpenInAppActivity](https://github.com/honkmaster/TTOpenInAppActivity)
...
## [TTSwitch](http://github.com/twotoasters/TTSwitch)
...
## [TumbleOn-Utils](http://www.tumbleonapp.com/code)
...
## [TXMainThreadCoreDataHelper](https://github.com/TonnyXu/TXMainThreadCoreDataHelper)
It's a simple tool to help you use CoreData in your multithreaded iOS/Mac app CORRECTLY.
## [Typewriter](https://github.com/rdavies/Typewriter)
...
## [UAModalPanel](http://coneybeare.net)
An animated modal panel alternative for iOS.
## [UDBarTrackballItem](https://github.com/djui/UDBarTrackballItem)
...
## [UDTableView](https://github.com/ud7/UDTableView-allowsMultipleSelection)
...
## [UIBezierPath-Symbol](https://github.com/Kjuly/UIBezierPath-Symbol)
Symbol extension for UIBezierPath class (UIBezierPath category).
## [UIBubbleTableView](http://alexbarinov.github.com/UIBubbleTableView/)
Cocoa UI component for chat bubbles with avatars and images support.
## [UIColor+MLPFlatColors](http://github.com/EddyBorja/UIColor-MLPFlatColors)
...
## [UIDeviceAddition](https://github.com/gekitz/UIDevice-with-UniqueIdentifier-for-iOS-5)
...
## [UIGlossyButton](https://github.com/waterlou/UIGlossyButton)
...
## [UIImage-Categories](https://github.com/tonyzonghui/UIImage-Categories)
...
## [UIResponder+KeyboardCache](https://github.com/mbrandonw/UIResponder-KeyboardCache)
A simple workaround to the annoying problem of keyboard lag.
## [UIResponder+MNActions](http://github.com/madninja/UIResponder+MNActions)
...
## [UITableView-NXEmptyView](https://github.com/nxtbgthng/UITableView-NXEmptyView)
A category on UITableView that adds an empty view that can be shown whenever the table view has no cells.
## [UITextView+PinchZoom](https://github.com/cfr/UITextView-PinchZoom)
Simple pinch-zoom category for UITextView.
## [UIView+FrameAdditions](https://gist.github.com/nfarina/3412730)
jQuery-like getter/setter category methods for UIView frame components.
## [UIView+Helpers](https://github.com/andrewroycarter/UIView-Helpers)
UIView+Helpers is a collecion of methods that make laying out UIViews easier and readable.
## [UIView+TKGeometry](http://github.com/mapedd/UIView-TKGeometry)
Category methods for UIView for easy size, center and origin manipulation.
## [uiview-frame-helpers](http://github.com/cameronboehmer/uiview-frame-helpers)
Less code to position and resize UIView objects.
## [UIViewDrawRectBlock](https://github.com/hsjunnesson/UIViewDrawRectBlock)
...
## [UIViewPlusPosition](http://github.com/tylerneylon/moriarty)
Position category on UIView.
## [UIWebViewRemoveShadow](https://github.com/markrickert/UIWebView-RemoveShadow)
...
## [uploadcare-ios](https://uploadcare.com)
iOS library for Uploadcare.
## [upnpx](http://code.google.com/p/upnpx/)
...
## [UrbanAirship-iOS-SDK](https://github.com/urbanairship/ios-library)
...
## [uservoice-iphone-sdk](http://www.uservoice.com/iphone)
UserVoice for iOS allows you to embed UserVoice directly in your iPhone or iPad app.
## [V8HorizontalPickerView](https://github.com/veader/V8HorizontalPickerView)
A horizontal UIPickerView control for iOS.
## [VeriJSON](https://bitbucket.org/dcutting/verijson)
An Objective-C library for verifying JSON against a pattern-based schema.
## [vfrReader](http://www.vfr.org/)
An open source PDF file reader/viewer for iOS.
## [VideoPlayerKit](https://github.com/ign/VideoPlayerKit)
...
## [ViewUtils](https://github.com/nicklockwood/ViewUtils)
...
## [VIHorizontalTableView](https://github.com/yas375/VIHorizontalTableView)
A few superclasses and docs for making horizontal table views.
## [Vkontakte-iOS-SDK](https://github.com/StonerHawk/Vkontakte-iOS-SDK)
The iOS SDK provides Vkontakte Platform support for iOS apps.
## [VLMHarlemShake](https://github.com/velos/VLMHarlemShake)
A harlem shake implementation for iOS.
## [vMAT](http://kaelin.github.io/vMAT/)
The vMAT library implements a grab-bag of mathematical functions inspired by MATLAB.
## [VPPCoreData](http://github.com/vicpenap/VPPCoreData)
...
## [VPPLocation](https://github.com/vicpenap/VPPLocation)
...
## [VPPReachability](https://github.com/vicpenap/VPPReachability)
VPPReachability Library for iOS simplifies access to the status of a given hostname.
## [watoolkitios](https://github.com/WindowsAzure-Toolkits/wa-toolkit-ios.git)
...
## [WebContentView](http://charcoaldesign.co.uk/source/cocoa#webcontentview)
...
## [WebViewJavascriptBridge](http://github.com/marcuswestin/WebViewJavascriptBridge)
A standalone iOS class for sending messages to and from javascript in a UIWebView.
## [WeChatSDK](http://dev.wechatapp.com/)
...
## [WFImagePickerPlus](https://github.com/whalefood/WFImagePickerPlus)
...
## [WhirlyGlobe-Headers](https://github.com/mousebird/WhirlyGlobe)
WhirlyGlobe headers is a self contained 3D earth display view suitable for use in iPhone and iPad applications. (temporary).
## [WindowsAzureACS-iOS](http://github.com/auth10/WindowsAzureACS-iOS)
...
## [WindowsAzureMobileServices](http://www.windowsazure.com/ios/)
Windows Azure Mobile SDK for iOS.
## [WKTParser](https://github.com/joelturnbull/WKTParser)
...
## [XBPageCurl](https://github.com/xissburg/XBPageCurl)
...
## [XRay](http://mireus.com/framework/)
...
## [YandexGeocoder](https://github.com/exister/YandexGeocoder)
Use Yandex Geocoding API for forward and reversed geocoding.
## [YandexMapKit](https://github.com/yandexmobile/yandexmapkit-ios)
...
## [YRDropdownView](http://buildinternet.com/2012/02/yrdropdownview-a-polite-uialertview-alternative-for-ios/)
YRDropdownView is a view library for displaying stylish alerts, warnings, and errors.
## [YTFExtensions](https://github.com/MobileDevs/YTFExtensions.git)
YTFExtensions - extensions and categories.
## [YTFKeyboardCorrector](https://github.com/yetithefoot/YTFKeyboardCorrector)
Corrector for keyboard used in iOS.
## [YTFPlaceholderTableView](https://github.com/yetithefoot/YTFPlaceholderTableView)
UITableView with placeholder view.
## [YTFToggler](https://github.com/yetithefoot/YTFToggler)
...
## [ZAActivityBar](https://github.com/zacaltman/ZAActivityBar)
...
## [ZeroPush](https://www.zeropush.com)
ZeroPush is a lightweight wrapper for the ZeroPush API.
## [ZFCardinalDirection](https://github.com/flightblog/ZFCardinalDirection)
Cardinal & ordinal compass directions from a compass heading in degrees, (aka Boxing the Compass).
## [ZFHaversine](https://github.com/flightblog/ZFHaversine)
...
## [ZGCountDownTimer](https://github.com/zhigang1992/ZGCountDownTimer.git)
Background Proof, Termination Proof Timer, Reboot Proof Timer.
## [ZGParallelView](https://github.com/zhigang1992/ZGParallelView)
...
## [ZKSforce](https://github.com/superfell/zkSforce)
A Cocoa library for calling the Salesforce.com SOAP APIs.
## [ZKTextField](https://github.com/alexzielenski/zktextfield)
